## -------------------------------------------------------------------------
##
## Script name: 4.1_FT_randomize.R
##
...
## -------------------------------------------------------------------------
##
## Notes:      This script is part of the 4_FTclassification.R script,
...
saveRDS(random, paste0("./Objects/FT_randomization_output_", Sys.Date(), ".rds"))
...
# Save -----------------------------------------------------------------------------------------------
saveRDS(df,paste0("./Objects/FT_randomization_CI_", Sys.Date(), ".rds"))
